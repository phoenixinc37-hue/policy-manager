      ...
      <div style={{ maxWidth: 980, margin: "0 auto", padding: "24px 16px 48px" }}>
        <header style={headerCard}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div>
              <div style={{ fontSize: 20, fontWeight: 700 }}>Policy Manager <span style={{ fontSize: 20, fontWeight: 700, color: "#2e7d32", marginLeft: 10 }}>· Use Template</span></div>
        ...
        <main style={{ marginTop: 24 }}>
          <section style={card}>
            <div style={{ fontSize: 28, fontWeight: 800, marginBottom: 8 }}>Follow the established template</div>
            <div style={{ fontSize: 14, color: "#60766b", lineHeight: 1.7, marginBottom: 18 }}>
              In the live version, this route will use the firm’s approved template for each document type so new drafts follow a consistent structure before approval.
            </div>
            <div style={{ display: "grid", gap: 12 }}>
              <div style={row}><strong>Step 1</strong><span>Select Policy, SOG, or Memo.</span></div>
              <div style={row}><strong>Step 2</strong><span>Open the approved template for that document type.</span></div>
              <div style={row}><strong>Step 3</strong><span>Send the completed draft into the correct approval pathway.</span></div>
            </div>
          </section>
        </main>
      </div>
