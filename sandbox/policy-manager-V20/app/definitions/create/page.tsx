...
import { saveDefinitionAction } from "../../actions";
...
export default function CreateDefinitionPage() {
  ...
  const saveDefinition = async () => {
    ...
    await saveDefinitionAction(key, label.trim(), definition.trim());
      ...
      <div style={{ maxWidth: 980, margin: "0 auto", padding: "24px 16px 48px" }}>
        <header style={headerCard}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <CabinetGraphic />
            <div>
              <div style={{ fontSize: 20, fontWeight: 700 }}>Policy Manager V20 <span style={{ fontSize: 20, fontWeight: 700, color: "#2e7d32", marginLeft: 10 }}>· Add Definition</span></div>
