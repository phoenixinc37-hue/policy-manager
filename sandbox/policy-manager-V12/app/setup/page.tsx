      ...
      <div style={{ maxWidth: 1180, margin: "0 auto", padding: "24px 16px 48px" }}>
        <header style={headerCard}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <CabinetGraphic />
            <div>
              <div style={{ fontSize: 20, fontWeight: 700 }}>Policy Manager V11 <span style={{ fontSize: 20, fontWeight: 700, color: "#2e7d32", marginLeft: 10 }}>· Setup</span></div>
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            ...
            <Link href="/create" style={whiteTopButton}>Create</Link>
          </div>
        </header>
        ...
        <main style={{ marginTop: 24, display: "grid", gap: 20 }}>
          <section style={heroCard}>
            ...
            <div style={{ fontSize: 15, color: "#60766b", lineHeight: 1.7, maxWidth: 840 }}>
              Customize your Policy Manual one question at a time. Use suggestions or create your own.
            </div>
          </section>
