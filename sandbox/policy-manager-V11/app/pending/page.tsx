...
import { loadPendingDrafts, type SavedDraftRecord } from "../create/ai-assistant/draftStorage";

export default function PendingPage() {
  const hardcodedPending = documents.filter((doc) => doc.status === "pending-approval");
  const [localPending, setLocalPending] = useState<SavedDraftRecord[]>([]);

  useEffect(() => {
    setLocalPending(loadPendingDrafts());
  }, []);
