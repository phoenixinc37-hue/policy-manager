...
export default function CompletionReviewPage({ params }: { params: { docId: string } }) {
      ...
      <div style={{ maxWidth: 980, margin: "0 auto", padding: "24px 16px 48px" }}>
        <header style={headerCard}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <CabinetGraphic />
            <div>
              <div style={{ fontSize: 20, fontWeight: 700 }}>Policy Manager <span style={{ fontSize: 20, fontWeight: 700, color: "#dc2626", marginLeft: 10 }}>· Review Cycle</span></div>
        ...
        <main style={{ marginTop: 24 }}>
          <section style={card}>
            <div style={{ fontSize: 28, fontWeight: 800, marginBottom: 8 }}>{doc.title} review schedule</div>
            <div style={{ display: "grid", gap: 12 }}>
              <div style={row}><strong>Current status</strong><span>Fully circulated</span></div>
              <div style={row}><strong>Next review date</strong><span>September 30, 2026</span></div>
              <div style={row}><strong>Review owner</strong><span>Owners / leadership group</span></div>
            </div>
          </section>
        </main>
      </div>
