      ...
      <div style={{ maxWidth: 1180, margin: "0 auto", padding: "24px 16px 48px" }}>
        <header style={headerCard}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <CabinetGraphic />
            <div>
              <div style={{ fontSize: 20, fontWeight: 700 }}>Policy Manager <span style={{ fontSize: 20, fontWeight: 700, color: "#dc2626", marginLeft: 10 }}>· Create New</span></div>
        ...
        <main style={{ marginTop: 24 }}>
          <section style={panelCard}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: 18, marginBottom: 20 }}>
              <div style={featureCard}>
                ...
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 14 }}>
                  <Link href="/create/ai-assistant" style={whiteButtonLink}>Use AI assistant</Link>
                  <Link href="/create/template" style={whiteButtonLink}>Build manually</Link>
                </div>
              </div>
              ...
              <div style={featureCard}>
                ...
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 14 }}>
                  <Link href="/import-existing" style={whiteButtonLink}>Upload file</Link>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: "grid", gap: 16 }}>
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                <Link href="/create?type=policy" style={activeType === "policy" ? activeWhiteTypeLinkButton : whiteTypeLinkButton}>Policy</Link>
                <Link href="/create?type=sog" style={activeType === "sog" ? activeWhiteTypeLinkButton : whiteTypeLinkButton}>SOG</Link>
                <Link href="/create?type=memo" style={activeType === "memo" ? activeWhiteTypeLinkButton : whiteTypeLinkButton}>Memo</Link>
              </div>
...
const activeWhiteTypeLinkButton = {
  textDecoration: "none",
  background: "#ffffff",
  color: "#10221a",
  padding: "10px 16px",
