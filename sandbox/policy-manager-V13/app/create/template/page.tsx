      ...
      <div style={{ maxWidth: 1080, margin: "0 auto", padding: "24px 16px 48px" }}>
        <header style={headerCard}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <CabinetGraphic />
            <div>
              <div style={{ fontSize: 20, fontWeight: 700 }}>Policy Manager <span style={{ fontSize: 20, fontWeight: 700, color: "#dc2626", marginLeft: 10 }}>· Build Manually</span></div>
        ...
        <main style={{ marginTop: 24 }}>
          <section style={card}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginTop: 24, gap: 12 }}>
              <Link href="/create/template/draft" style={previewButton}>See draft</Link>
              <Link href="/create/template/draft" style={saveButton}>Save</Link>
            </div>
          </section>
        </main>
      </div>
