...
import { deleteSavedDraft, loadSavedDrafts, moveDraftToApproval, type SavedDraftRecord } from "../draftStorage";
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "24px 16px 48px" }}>
        <header style={headerCard}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <CabinetGraphic />
            <div>
              <div style={{ fontSize: 20, fontWeight: 700 }}>Policy Manager <span style={{ fontSize: 20, fontWeight: 700, color: "#dc2626", marginLeft: 10 }}>· Saved Drafts</span></div>
                      ...
                      <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            moveDraftToApproval(draft.id, reviewers);
